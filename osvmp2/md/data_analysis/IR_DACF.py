...
#fname = 'dip_mom_porphycene_MP2.dat'
fname = '/Users/calvin/Dropbox/code/MPI/work/results/augccpvdz/zundel_1e-2_0.2/dip_mom_zundel_MP2.dat'
delta_t = 0.5 * 1.0e-15
window = 'Hamming'
fout = 'IR.txt'
...
def read_data(fname):
    with open(fname, "r") as fo:
        dipole = np.loadtxt(fo, dtype=np.float64, usecols=(0,1,2))
    return dipole
